...
//        return ux == BootpayUX.BOOTPAY_REMOTE_LINK || ux == BootpayUX.BOOTPAY_REMOTE_FORM || ux == BootpayUX.BOOTPAY_REMOTE_PRE
//    }
//
//    static func isUXApp2App(_ ux: BootpayUX) -> Bool {
//        return ux == BootpayUX.APP2APP_REMOTE || ux == BootpayUX.APP2APP_CARD_SIMPLE || ux == BootpayUX.APP2APP_NFC || ux == BootpayUX.APP2APP_SAMSUNGPAY || ux == BootpayUX.APP2APP_SUBSCRIPT
//            || ux == BootpayUX.APP2APP_CASH_RECEIPT || ux == BootpayUX.APP2APP_OCR
//    }
}
