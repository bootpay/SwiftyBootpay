...
let kSetPasscodeToUseTouchID = "Touch ID를 사용하려면, 비밀번호를 설정해주세요."
...
let kSetPasscodeToUseFaceID = "Face ID를 사용하려면, 비밀번호를 설정해주세요."
let kNoFaceIdentityEnrolled = "기기에 등록 된 얼굴이 없습니다. 설정 → 얼굴 ID 및 비밀번호로 이동하여 얼굴을 등록하세요."
